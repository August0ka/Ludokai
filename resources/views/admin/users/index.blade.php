...
@section('content')
    <div class="overflow-x-hidden">
        ...
        <div class="hidden md:block rounded-lg mt-5">
            <table class="table-auto text-[10px] md:text-sm w-full border-collapse rounded-lg overflow-hidden">
                <thead>
                        ...
                        <tr class="text-gray-200 odd:bg-blue-night-800 even:bg-blue-night-900">
                            ...
                            <td class="flex px-4 py-2">
                                ...
                                <button type="button"
                                    ...
                                    data-url="{{ route('admin.users.destroy', '') }}" value="{{ $user->id }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="text-pumpkin-100 size-5">
                                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="md:hidden grid grid-cols-1 gap-4">
            @forelse($users as $user)
                <div
                    class="text-gray-200 odd:bg-blue-night-800 even:bg-blue-night-900 rounded-lg shadow overflow-hidden hover:shadow-md transition-shadow">
                    <div class="p-4">
                        <div class="flex items-center justify-between mb-3">
                            <h3 class="text-lg font-medium text-gray-100">Usuário #{{ $user->id }}</h3>
                        </div>
                        ...
                        <div class="mt-4 flex justify-end space-x-2">
                            <a href="{{ route('admin.users.edit', $user->id) }}"
                                class="px-3 py-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200">Editar</a>
            ...
            @empty
                <div class="text-gray-200 bg-blue-night-800 rounded-lg shadow p-6 text-center">
                    ...
                    <h3 class="text-xl font-medium mb-2">Nenhum usuário encontrado</h3>
                    <p class="text-gray-400 mb-4">Não há registros de usuários disponíveis no momento.</p>
                </div>
            @endforelse
        </div>
    </div>
