...
<div class="overflow-x-hidden">
    <div class="flex justify-between items-center mt-8 mb-6 md:mt-0">
        <div class="text-2xl font-bold text-pumpkin-200">Categorias</div>
        <div class="my-2">
            ...
            <tbody>
                ...
                <tr class="text-gray-200 odd:bg-blue-night-800 even:bg-blue-night-900">
                    ...
                    <td class="flex px-4 py-2">
                        ...
                        <button type="button" data-url="{{ route('admin.categories.destroy', '') }}"
                            value="{{ $category->id }}"
    ...
    <div class="md:hidden grid grid-cols-1 gap-4">
        ...
        <div class="text-gray-200 odd:bg-blue-night-800 even:bg-blue-night-900 rounded-lg shadow overflow-hidden hover:shadow-md transition-shadow">
            <div class="p-4">
                <div class="flex items-center justify-between mb-3">
                    <h3 class="text-lg font-medium text-gray-100">Categoria #{{ $category->id }}</h3>
                </div>
                ...
                <div class="mt-4 flex justify-end space-x-2">
                    <a href="{{ route('admin.categories.edit', $category->id) }}" class="px-3 py-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200">Editar</a>
        ...
        <div class="text-gray-200 bg-blue-night-800 rounded-lg shadow p-6 text-center">
            ...
            <h3 class="text-xl font-medium mb-2">Nenhuma categoria encontrada</h3>
            <p class="text-gray-400 mb-4">Não há registros de categorias disponíveis no momento.</p>
        </div>
        @endforelse
    </div>
</div>
...
<script>
    $(document).ready(function() {
        $(".delete-button").on('click', function() {
            ...
            let deleteUrl = `${baseUrl}/${categorieId}`;
