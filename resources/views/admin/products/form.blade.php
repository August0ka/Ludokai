                        ...
                        <div class="flex flex-wrap gap-2 mt-3">
                            @foreach ($product->productImages as $productImage)
                                <div class="relative w-20 h-20" id="{{ $productImage->id }}">
                                    ...
                                    <button
                                        class="absolute -top-2 -right-2 bg-red-600 text-white rounded-full w-6 h-6 text-xs flex items-center justify-center remove-btn"
                                        data-id="{{ $productImage->id }}" data-file="{{ $productImage->id }}">
                                        ×
                                    </button>
                                </div>
                            @endforeach
