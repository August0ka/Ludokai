    ...
    <div class="mt-10 mx-10 grid grid-cols-12 gap-8 justify-center">
        <div class="col-span-6">
            <div class="flex flex-col">
                <div class="bg-vivid-violet-200 shadow-lg rounded-lg mb-6">
                    <div class="bg-pumpkin-100 rounded-lg px-6 py-4 font-semibold text-gray-700">
                        Endereço de entrega
                    </div>
                    <div class="p-6">
                ...
                <div class="col-span-6 bg-vivid-violet-200 shadow-lg rounded-lg">
                    <div class="bg-pumpkin-100 rounded-lg px-6 py-4 font-semibold text-gray-700">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center mt-4">
                            ...
                            <input type="number" id="infoQuantity"
                                class="border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-center w-20"
                                value="1" min="1">
                            @if ($errors->has('error'))
                        ...
                        <p class="mt-4 text-gray-700"><strong>Preço unitário:</strong> R$
                            {{ number_format($product->price, 2, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-span-6 bg-vivid-violet-200 shadow-lg rounded-lg h-full">
            <div class="bg-pumpkin-100 rounded-lg px-6 py-4 font-semibold text-gray-700">
                Resumo do Pedido
            </div>
            <div class="p-6">
                ...
                <p class="text-gray-700 mt-2" id="totalValue"><strong>Total:</strong>
                ...
                <form action="{{ route('sales.store') }}" method="POST" class="mt-6">
                    ...
                    <button type="submit"
                        class="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2 rounded-lg shadow-md">
                        Finalizar Compra
                    </button>
                </form>
            </div>
