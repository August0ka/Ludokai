    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="https://flowbite.com" class="flex items-center">
                ...
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Lojinha legal</span>
            </a>
            <div class="flex items-center lg:order-2">
                ...
                <a href="#"
                    class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4
                     ...
                     lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                    Cadastrar
                </a>
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 
                             ...
                             dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Produto</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 
                            lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700
                            lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700
                            dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Categoria</a>
                    </li>
                </ul>
            </div>
        </div>
