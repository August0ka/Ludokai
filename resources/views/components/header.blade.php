    ...
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <div class="text-end">
        ...
        <div class="d-flex align-items-center">
          <span class="text-white me-2">Olá, Teste</span>
          <div>
        ...
        @endauth
        @guest
        <a type="button" href="/" class="btn btn-outline-light me-2">Login</a>
        <a type="button" href="/" class="btn btn-warning">Registrar</a>
        @endguest
      </div>
    </div>
  </div>
